...
//extern forceinline uint64_t LOADBYTES(const uint8_t* bytes, int n);
//extern forceinline void STOREBYTES(uint8_t* bytes, uint64_t w, int n);
//extern void P(ascon_state_t* s, int nr);
//extern forceinline void ROUND(ascon_state_t* s, uint8_t C);
